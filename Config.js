global.settings = {
    OWNER_NUMBERS: "2348077636701", // replace with your number
    OWNER_NAME: 'Sodish Int', // desired name
    BOT_NAME: "KORD", // desired name
    VERSION: 'V1.0.0',
    SESSION_ID: 'kord_ai-6752a07a32154d884b2bfc4c', //put your session id between ''
